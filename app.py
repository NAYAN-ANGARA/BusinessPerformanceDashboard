...
# ============================================================
def robust_parse_dates(series, primary_format="mixed"):
    """
    Try multiple date parsing strategies.
    Returns a Series of datetime (NaT for failures).
    """
    # First attempt: let pandas guess (with mixed format)
    ...
    # Last resort: let pandas do it with mixed format (slow but works)
...
def load_and_process_data():
    ...
    if spend_df is None:
        ...
        if date_col is None:
            ...
            spend_df["date"] = robust_parse_dates(spend_df[date_col])
